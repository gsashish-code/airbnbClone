...
public class HotelBookingServiceImpl implements HotelBookingService {
  ...
  public BookingDto initializeBooking(BookingRequest bookingRequest) {
            ...
            .orElseThrow(
                () ->
                    new ResourceNotFoundException(
                        "hotel with the id not found: " + bookingRequest.getHotelId()));
    Room room =
        roomRepository
    ...
    long daysCount =
        ChronoUnit.DAYS.between(bookingRequest.getCheckInDate(), bookingRequest.getCheckOutDate())
            + 1;
    ...
    Booking booking =
        Booking.builder()
            .bookingStatus(BookingStatus.RESERVE)
            .hotel(hotel)
            .room(room)
